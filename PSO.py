...
class PSO:
    def __init__(self, dim, size, iter_num, x_max,x_min, max_vel, best_fitness_value=float('Inf'), C1=2, C2=2, W=1):
        self.C1 = C1
        self.C2 = C2
        self.W = W
        self.dim = dim  # 粒子的维度
    ...
    def update_vel(self, part):
        for i in range(self.dim):
            ...
            elif vel_value < self.x_min:
                vel_value = self.x_min
...
if __name__ == '__main__':
    ...
    pso = PSO(dim, size, iter_num, x_max,x_min, max_vel)
